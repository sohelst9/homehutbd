...
<div class="row">
    <div class="col-md-6">
        <a style="text-decoration:none; color:white;" href="{{ route('brand.index') }}"><h1 class="h3">All Brands</h1></a>
    </div>
    ...
    <div class="col-lg-12 mt-3">
        <div class="card">
            ...
            @endif
                <form class="search float-right mb-3" action="{{ route('brand.index') }}" method="GET">
                    <input type="text" name="brand" class="form-control" placeholder="Search Brand" style="width:200px;">
                  </form>
