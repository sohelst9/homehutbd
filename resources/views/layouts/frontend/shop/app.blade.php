    ...
    <div class="container-fluid">
        <div class="row border-top px-xl-5">
            <div class="col-lg-3 d-none d-lg-block">
                ...
                <nav class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0" id="navbar-vertical" style="width: calc(100% - 30px); z-index: 1;">
                    <div class="navbar-nav w-100 overflow-hidden" style="background-color: #d8d8d8;">
                        @php
                            $cate = categories();
                        @endphp
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu position-absolute bg-secondary border-0 rounded-0 w-100 m-0">
                                    @foreach ($category->Subcategory as $subcategory)
                                        <a href="{{ route('subcategory.shop',$subcategory->id) }}" class="dropdown-item">{{ $subcategory->subcategory }}</a>
                                    @endforeach
                                </div>
                            </div>
                        @endforeach
