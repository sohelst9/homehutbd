    ...
    <div style="margin-top:20px">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">{{ $cate_id->name }}</li>
            </ol>
        </nav>
    </div>
    <!-- Page Header End -->
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-4 pb-1">
                            <div class="card product-item border-0 mb-4">
                                <div
                                    ...
                                    <a href="{{ route('single.Product', $cate_product->id) }}"><img class=" w-100" height="236px"
                                        src="{{ asset('storage/backend/upload/product/thumbnailImage/' . $cate_product->thumbnailImage) }}"
                                        alt=""></a>
                                </div>
                                <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                    <a href="{{ route('single.Product', $cate_product->id) }}"
                                        style="text-decoration: none;">
                                        <h6 class="pr_cate">{{ $cate_product->subcategory->subcategory }}</h6>
                                        <h6 class="product_name">{{ substr($cate_product->productName, 0, 20) . '...' }}</h6>
                                    </a>
                                    <div class="d-flex justify-content-center">
                                        <h6 style="font-size: 14px; color:rgb(221, 69, 27);">&#2547;
                                            {{ $cate_product->after_discount }}</h6>
                                        <h6 class="text-muted ml-2"
                                            style="font-size: 12px; color:#646060; margin-top:1px;">
                                            <del>&#2547; {{ $cate_product->productPrice }}</del></h6>
                                    </div>
                                </div>
